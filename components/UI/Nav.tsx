...
export const Nav = () => {
  ...
  return (
    <>
      ...
      >
        <Box background='#fff' padding='20px'>
          <Flex className='container' colCenter justifyContent='space-between'>
            <Text width='100px' family='Shadows Into Light' lh='0.9' size={24}>
              Leonardo Guanuco
            </Text>
            <Box dNoneXL>
              <Flex columnGap={30}>
                <a style={{ color: '#000' }} href='#inicio'>
                  Inicio
                </a>
                <a style={{ color: '#000' }} href='#sobremi'>
                  Sobre mí
                </a>
                <a style={{ color: '#000' }} href='#proyectos'>
                  Proyectos
                </a>
                <a style={{ color: '#000' }} href='#contacto'>
                  Contacto
                </a>
              </Flex>
            </Box>
            <Box dNoneXL>
              <Link
                href='https://www.linkedin.com/in/leonardo-guanuco-javascript-typescript/'
                target='_blank'
      ...
      <NavResponsive active={activeNavBar}>
