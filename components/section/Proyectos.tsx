...
export const Proyectos = () => {
  ...
  const proyectoContainer = useMemo(() => {
    return <ProyectoContainer technologies={options} />;
  }, [options]);

  return (
    <>
      <Section ref={ref} id='proyectos' background='#000' ovHidden>
        <Box rotate='3deg'>
          <LineHead background='yellow'>
            <Flex columnGap={50}>
              <Title className='f-auto' size={55} sizeXL={35} color='#fff'>
                PROYECTOS
              </Title>
              <Title className='f-auto' size={55} sizeXL={35} color='#000'>
                PROYECTOS
              </Title>
              <Title className='f-auto' size={55} sizeXL={35} color='#fff'>
                PROYECTOS
        ...
        <Box className='container'>
          <Flex colCenter justifyContent='space-between' columnXS gap={20}>
            <Text color='#fff' size={18}>
              Buscar con las siguientes tecnologías:
            </Text>
            <Select>
              <Flex
              ...
              {isSelect && (
                <Position top='120%' left='0' width='100%'>
                  <Box
                    ...
                    overflowY
                  >
                    <Box padding='0 0 0 10px' onClick={handleRestartOption}>
                      <Text>Ver Todos</Text>
                    </Box>
